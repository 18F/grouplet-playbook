...
When faced with the task of forming a new grouplet, it's useful
...
helps to clarify your thinking and course of action, and it serves as an effective
[recruting artifact](#recruiting) that helps prospective volunteers get a feel for
the grouplet and how they might contribute to it.

## <a name="mission"></a>The mission statement

Every grouplet needs a one-sentence mission
statement describing why it exists. It's the reason for
starting a grouplet in the first place, and it's vital to articulate this reason clearly. 
The mission statement is the first item in
your [recruiting toolkit](#recruiting) and appears at the 
top of your [two-pager](#two-pager) artifact.
...
- **18F Working Group Working Group**: Create an environment in which
...
The Objectives and Key Results (OKRs) process is a quarterly
...
[two-pager](#two-pager), they better understand priorities and begin to
imagine how the grouplet can succeed in acheiving its goals. This boosts your
credibility as a leader, as someone who ensures limited time is
...
other grouplet members, grouplets must establish a basic,
...
overall effort. Also, when responsibilities are clear, grouplet members can
manage tasks by going directly to the appropriate role-holder, rather
than remaining in the critical path of every decision. In
other words, "creativity is pushed toward the edge of the organization." (Need
...
meeting room, manages remote coordination, ensures that minutes are posted in a timely manner.
...
content, for example the use of tags, application of CSS styles, and traditional SEO
...
grouplet exists and _is up to something._ The artifact should invite
cultivation, grow along with the grouplet itself, and provide the
...
You've defined a [mission](#mission), broken out [Objectives and Key
...
- **One-on-one**: Set up brief appointments with prospective recruits to engage
  ...
  their thoughts and opinions. If they seem interested, recruit them into one or
...
Use your [two-pager](#two-pager) as the official agenda for
the first kick-off meeting. Ideally, you've already had a one-on-one [recruiting
chat](#recruiting) with most of the people in the room; this ensures the
meeting goes quickly and that people other than the organizers have a
chance to speak about their ideas.

## <a name="meetings"></a>Weekly meetings

After the warm-fuzzies of the initial [recruiting phase](#recruiting) and the
[kick-off meeting](#kick-off) have worn off, maintain momentum
and team cohesion by holding brief weekly meetings, ideally only 30
minutes. Though modern professionals have grown very wary of meetings, when run
well, they are the best tool for ensuring people continue to
identify with the grouplet and feel a sense of progress.

That said, organizers must ensure these meetings are run
as well as possible. They should review a grouplet [task list](#tasklist)
every week. Organizers should also draft a [one-page agenda](#agenda)
and publish it at least one day prior to each meeting; this gives people an idea
of the week's business and affords them the opportunity to put new items on the
...
The grouplet should maintain a centralized task list to track all the
different efforts underway, large and small. The beginning of each [weekly
meeting](#meetings) should be a very quick review of this list; add items
as necessary during the remainder of the meeting.
...
and promising action items aren't forgotten as well as to make a habit of celebrating
 items that are completed, so that members feel like their efforts are
...
discuss any items for which they're responsible. If something they'd like
...
something is better than nothing. A recommended structure for the document is:
...
weekly meeting, since they usually engage fewer people who are 
interested in the outcome of a single issue. Those who attend the
...
Fixits are traditionally one-day sprints where people put aside
